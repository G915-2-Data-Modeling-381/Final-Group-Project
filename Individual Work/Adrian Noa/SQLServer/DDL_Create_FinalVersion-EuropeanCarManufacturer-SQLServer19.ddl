...
( 
	...
	ManufacturerVehicleModelYear dDate.Year 
		 DEFAULT  '1999'
		CHECK  ( [ManufacturerVehicleModelYear] LIKE '[0-9][0-9][0-9][0-9]' ),
	Note                 dString.AuditNote  NULL 
		CHECK  ( [Note] LIKE '%' ),
	SysStartTime         dDate.CurrentTimeStamp  NULL 
		 DEFAULT  sysdatetime(),
    ...
    BEGIN
        ...
        SELECT @NumberOfRows = @@rowcount
                ...
                ----------------------------------
                    ...
                    (
                        ManufacturerVehicleModelId , ManufacturerVehicleMakeId , ModelName , ModelVariant , ManufacturerVehicleModelYear , Note , SysStartTime , SysEndTime , UserAuthenticatedKey 
